...
const Header = () => {
    ...
    const isActive = (path) => pathName === path ? 'bg-slate-900 hover:bg-slate-900 text-white hover:text-white rounded-md px-3 py-2' : 'text-white  hover:text-white rounded-md px-3 py-2';
  return (
        ...
        <div className='relative flex h-20 items-center justify-between'>
          ...
          <div className='flex flex-1 items-center justify-center md:items-stretch md:justify-start'>
            ...
            <div className='hidden md:ml-10 md:block'>
              <div className='flex space-x-2'>
                ...
                <Link
                  href='/properties/add'
                  className={`${isActive('/properties/add')}`}
                >
                  Add Property
                </Link>
              </div>
          ...
          <div className='hidden md:block md:ml-6'>
            <div className='flex items-center'>
              <button className='flex items-center text-white bg-slate-400 hover:bg-gray-900 hover:text-white rounded-md px-3 py-2'>
              <Image
